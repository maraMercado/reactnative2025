...
function mostrarAlumno(input) {
    var id = input[0], nombre = input[1]; // destructuring: te va a ver un array con un index en la posic input[0] y una string en la posic input[1], hacemelo id y nombre.
    console.log("ID: ".concat(id, " Alumno: ").concat(nombre));
}
alumnos.forEach(function (alumno, index) { return mostrarAlumno([index, alumno]); });
