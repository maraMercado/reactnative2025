...
/* Object.keys = nombres de las propiedades
     Object.values = valor de las propiedades
     Object. entries = ambos
*/


// Forma 1:
const propiedadesConValores = Object.entries(user);
console.log(propiedadesConValores);
...
for (let i = 0; i < propiedades.length; i++) {
    console.log("Propiedad:", propiedades[i], "- Valor:", valores[i]);
}
